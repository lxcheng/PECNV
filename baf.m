%function [heterbaf] = baf(normalcount,normaldepth,tumorcount,tumordepth,GC_name,map_name)
...
normalcount='C:\Users\lxcheng\Desktop\cnv\program\3breastcancer\ExomeSeqMiner_results\SA030N.count';
normaldepth='C:\Users\lxcheng\Desktop\cnv\program\3breastcancer\ExomeSeqMiner_results\SA030N.depth';
tumorcount='C:\Users\lxcheng\Desktop\cnv\program\3breastcancer\ExomeSeqMiner_results\SA030.count';
tumordepth='C:\Users\lxcheng\Desktop\cnv\program\3breastcancer\ExomeSeqMiner_results\SA030.depth';
GC_name='C:\Users\lxcheng\Desktop\cnv\program\3breastcancer\ExomeSeqMiner_results\hg18_exome.GC';
map_name='C:\Users\lxcheng\Desktop\cnv\program\3breastcancer\ExomeSeqMiner_results\hg18_exome.map';
...
%  % heterlist=baf_normal<1.1&baf_normal>-1;
...
%  clear tumorheterlist normalheterlist
  heterchr=depth_tumor{1};
  heterpos=depth_tumor{2};
  heterbaf=depth_tumor{3}/depth_tumor{4};
