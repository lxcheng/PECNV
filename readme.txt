code for paper "Detection of copy number variants and loss of heterozygosis from impure tumor samples using whole exome sequencing data"
PECNV is written in Matlab,to use the software ,you can simply use workflow function like below:
